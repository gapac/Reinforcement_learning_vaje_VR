function reward = reward_function(next_state)
    ...
    elseif next_state == pit_state
        reward = -100;  % pefunction reward = reward_function(next_state, lake, n)
        % This function should take the next state and return the corresponding reward.
        % You need to fill in the logic based on your specific problem.
    ...
    endnalty for falling into a pit
    end
end